...
const Summery = () => {
    return (
        <div style={{ backgroundImage: `url(${summery}` }} className=" bg-fixed grid grid-cols-1 lg:grid-cols-3 py-12 my-12  gap-y-12">
            <div className="text-white text-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
